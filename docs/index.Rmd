...
#### Installation
<h4><b>Step 1.</b> Install R, RStudio, and RTools45 in Company Portal</h4>
...
```{r, eval = F}
library(pak)
pkg_install("doi-nps/wetlandHTLN")
```
...
importData(type ='dbfile',
   filepath = '../data/HTLNwetlands3.5.2.accdb')
```
...
<li>View code in the <a href="https://github.com/doi-nps/wetlandHTLN/tree/main">GitHub doi-nps/wetlandHTLN repo</a>. The functions are in the R folder. 
